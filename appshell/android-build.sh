...
cmake	-DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK_HOME/build/cmake/android.toolchain.cmake \
      ...
      -DCMAKE_BUILD_TYPE=release -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 -DQTLESS=1 -DFULL_SRC_COMPILE=1 -DIMX_G2D=ON -DWITH_DWE=1 -DWITH_DRM=1 -DTUNINGEXT=1 -DSUBDEV_V4L2=1 .. -Wno-dev
