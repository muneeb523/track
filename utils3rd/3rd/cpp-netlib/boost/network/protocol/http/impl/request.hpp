...
struct basic_request : public basic_message<Tag> {
 ...
 public:
  ...
  void swap(basic_request& other) {
    ...
    boost::core::invoke_swap(other.uri_, this->uri_);
    boost::core::invoke_swap(other.source_port_, this->source_port_);
    boost::core::invoke_swap(other.sni_hostname_, this->sni_hostname_);
#else
