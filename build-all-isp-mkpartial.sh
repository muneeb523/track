...
cmake -DCMAKE_BUILD_TYPE=release -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 -DQTLESS=1 -DFULL_SRC_COMPILE=1 -DWITH_DWE=1 \
	-DTUNINGEXT=1 -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_INSTALL_INCLUDEDIR=include \
	-DWITH_DRM=1 -DSUBDEV_V4L2=1 -DSDKTARGETSYSROOT=$SDKTARGETSYSROOT -DIMX_G2D=ON .. -Wno-dev
fi
...
cmake -DCMAKE_BUILD_TYPE=debug -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 -DQTLESS=1 -DFULL_SRC_COMPILE=1 -DWITH_DWE=1 \
	-DTUNINGEXT=1 -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_INSTALL_INCLUDEDIR=include \
	-DWITH_DRM=1 -DSUBDEV_V4L2=1 -DSDKTARGETSYSROOT=$SDKTARGETSYSROOT -DIMX_G2D=ON .. -Wno-dev
fi
...
cmake -DCMAKE_BUILD_TYPE=release -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 \
	-DTUNINGEXT=1 -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_INSTALL_INCLUDEDIR=include \
	-DQTLESS=1 -DFULL_SRC_COMPILE=1 -DWITH_DWE=1 -DWITH_DRM=1 -DSUBDEV_V4L2=1 -DPARTITION_BUILD=0 \
	-D3A_SRC_BUILD=0 -DSDKTARGETSYSROOT=$SDKTARGETSYSROOT -DIMX_G2D=ON .. -Wno-dev
fi
...
git rm -rf units/isi/drv/OV2775
git rm -rf units/isi/drv/AR1335
git rm -rf units/isi/drv/basler-camera
git rm -rf units/isi/drv/IMX290
